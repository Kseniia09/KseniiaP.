...
//        RequestBody.create(bodyString, MediaType.parse("application/json"));
    ...
    public void createNewPostWithJson() throws IOException {

        JSONObject json = new JSONObject();
        json.put("userId", 1);
        json.put("title", "Json Post Title");
        json.put("body", "Json Post Body");
...
//    public void createNewPostWithGson(Post post) throws IOException {
//        Gson gson = new Gson();
